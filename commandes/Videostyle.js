...
*Enjoy 😂🔪*`;
    ...
    const contextInfo = {
      ...
      externalAdReply: {
        title: "LUCVOICE XMD",
        body: "Regards, ® Lucvoice",
        thumbnailUrl: "https://files.catbox.moe/t2CHARLESKE-𝐗𝐌𝐃   sourceUrl: "https://whatsapp.com/channel/0029Vao2hgeChq6HJ5bmlZ3K/",
        mediaType: 1,
      ...
      if (message.message.extendedTextMessage.contextInfo && message.message.extendedTextMessage.contextInfo.stanzaId === sentMessage.key.id) {
        ...
        if (logoUrl) {
          await zk.sendMessage(dest, {
            video: { url: logoUrl },
            mimetype: "video/mp4",
            caption: `*Downloaded by LUCVOICE-XMD*`,
          }, { quoted: ms });
        }
      }
    });
